...
public class AliasByTypeComparatorTest {
    ...
    public void sort() throws Exception {
        ...
        Assert.assertEquals( "gene name", aliases.get( 0 ).getAliasType() );
        Assert.assertEquals( "orf name", aliases.get( 1 ).getAliasType() );
        Assert.assertEquals( "locus name", aliases.get( 2 ).getAliasType() );
        Assert.assertEquals( "gene name synonym", aliases.get( 3 ).getAliasType() );
    }
}
