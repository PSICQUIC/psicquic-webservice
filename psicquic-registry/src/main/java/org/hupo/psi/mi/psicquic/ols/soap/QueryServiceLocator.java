...
public class QueryServiceLocator extends org.apache.axis.client.Service implements org.hupo.psi.mi.psicquic.ols.soap.QueryService {
    ...
    public org.hupo.psi.mi.psicquic.ols.soap.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	org.hupo.psi.mi.psicquic.ols.soap.OntologyQuerySoapBindingStub _stub = new org.hupo.psi.mi.psicquic.ols.soap.OntologyQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hupo.psi.mi.psicquic.ols.soap.Query.class.isAssignableFrom(serviceEndpointInterface)) {
            	org.hupo.psi.mi.psicquic.ols.soap.OntologyQuerySoapBindingStub _stub = new org.hupo.psi.mi.psicquic.ols.soap.OntologyQuerySoapBindingStub(new java.net.URL(OntologyQuery_address), this);
                _stub.setPortName(getOntologyQueryWSDDServiceName());
                return _stub;
            }
        }
