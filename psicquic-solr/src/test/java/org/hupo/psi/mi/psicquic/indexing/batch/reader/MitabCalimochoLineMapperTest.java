...
public class MitabCalimochoLineMapperTest {
    ...
    public void read_mitab_27() throws Exception {
        ...
        MitabCalimochoLineMapper mitabLineMapper = new MitabCalimochoLineMapper(MitabVersion.MITAB27);
    ...
    @Test
    public void read_mitab_25_default_argument_null() throws Exception {

        MitabCalimochoLineMapper mitabLineMapper = new MitabCalimochoLineMapper(null);
    ...
    @Test
    public void read_mitab_25_mitab27_input() throws Exception {
